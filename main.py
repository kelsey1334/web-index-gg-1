...
DAILY_LIMIT = 200
HPING_API_KEY = os.getenv("HPING_API_KEY")  # <— thay cho SINBYTE_API_KEY
...
async def ws_index(websocket: WebSocket, api_name: str, domain: str):
    try:
        ...
        # Đổi phần này: gửi lên 1hping thay vì Sinbyte
